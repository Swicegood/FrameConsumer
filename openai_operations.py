...
async def process_camera_state(camera_id, aggregated_description):
    ...
    Output one or more of the following states: "busy", "festival happening", "crowd gathering", "quiet", "person present"{additional_state} or "people eating". Please output only those words and nothing else.
